...
public class AppointmentControllerTest {
        ...
        //     .apply(springSecurity())
        //     .build();
        //         // CustomAuthenticationToken authentication = Mockito.mock(CustomAuthenticationToken.class);
        ...
        //         this.mockMvc = MockMvcBuilders.webAppContextSetup(this.context).build();
                ...
                Mockito.when(appointmentRepository.findByDoctorEmail(doctor.getEmail()))
                        ...
                        .filter(appointment -> appointment.getDoctor().getEmail().equals(doctor.getEmail()))
